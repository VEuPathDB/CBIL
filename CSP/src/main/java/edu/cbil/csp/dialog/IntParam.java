...
public class IntParam extends Param<Integer> {
    ...
    /**
     * Human-readable string describing the range and type 
     * constraints imposed by the parameter (e.g. "an integer between
     * 1 and 10, inclusive").  This String is generated automatically.
     */
    protected String constraint;

    /**
     * An array of sample values that meet the constraints imposed by
     * the parameter.
     */
    protected int sample_values[];
     ...
     */
    public IntParam(String name, String descr, String help,
		    StringTemplate st, StringTemplate ht, String prompt,
		    Integer min, Integer max, Integer initial, boolean optional,
		    int sample_values[]) 
    {
	...
	if (!optional && (input == null) || (input.equals(""))) {
	    errors.append("This parameter is required; you must enter an integer in " +
	...
	try {
	    ...
	    errors.append("The system was unable to parse the value entered, '" +
			  input + "', as a valid integer.  Please enter an integral " + 
