...
public class DoubleParam extends Param<Double> {
  ...
  /**
   * Human-readable string describing the range and type constraints imposed by the parameter (i.e. "This is a
   * decimal value between 0.25 and 0.50 inclusive.") This String is generated automatically.
   */
   ...
   */
  public DoubleParam(String name, String descr, String help, StringTemplate st, StringTemplate ht,
      String prompt, Double min, Double max, Double initial, boolean optional, Double sample_values[]) {
  ...
  public Item copy(String url_subs) {
    return new DoubleParam(name, descr, help, template, help_template, prompt, min, max, initial_value, optional,
        sample_values);
  }
  ...
  public boolean validateHTMLServletInput(HttpServletRequest rq, StringBuffer errors, Hashtable<String,Object> inputH,
    ...
    if (!optional && (input == null) || (input.equals(""))) {
      errors.append(
          "This parameter is required; you must enter a real number in " + "the range specified (if any).");
      return false;
    }
    ...
    try {
      ...
      errors.append("The system was unable to parse the value entered, '" + input +
          "', as a valid real number.  Please enter a real " +
  ...
  @Override
  public DoubleParam copyParam(String new_name) {
    return new DoubleParam(new_name, descr, help, template, help_template, prompt, min, max, initial_value,
        optional, sample_values);
  }

  @Override
  public Double convertToValue(String string) {
