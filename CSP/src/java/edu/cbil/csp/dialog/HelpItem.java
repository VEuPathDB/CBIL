 ...
 * HelpItem.java
 *
 * A help item that can appear in the middle of a dialog, instead
 * of the dialog's help section. The one unusual
 * aspect of this class is that it can potentially have additional
 * help information associated with it (which <b>will</b> appear 
...
public class HelpItem extends Item {
     ...
     * @param help_text    The help text that will appear in the main dialog.
     * @param extra_help   The "regular" help for the item, which <b>will</b> appear
     *                     in the dialog's help section.
     ...
     *                     element's help text.
     */
    public HelpItem(String name, String descr, String help_text,
		    String extra_help, StringTemplate st, StringTemplate ht) 
    {
