 ...
 *
 * Interface describing the string validators accepted by <code>FreeTextParam</code>.
 *
...
public interface StringValidatorI {
  ...
  /**
   * Called by <code>FreeTextParam</code> to ascertain if the value in <code>text</code> is valid. If the
   * value is invalid, the method may append a more specific error message to <code>errors</code>.
   *
   * @param text
   *          The text to be validated.
   * @param errors
   *          StringBuffer containing error messages, to which the method may append a message if it returns
   *          <code>false</code>.
   *
