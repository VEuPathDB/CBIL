...
class Element {
  ...
  public Element(String tag, boolean paired, AH attribs, AH depr) {
    this.tag = tag;
    this.paired = paired;
...
public class HTMLUtil {
  ...
  public static String urlEncode(String s) {
    try {
      ...
      throw new RuntimeException("Java no longer supports UTF-8 encoding", e);
    }
  }
  ...
  protected static Element elements[] = {
      // TAG = "a"
      new Element("A", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "charset", "%s", "type", "%s", "name", "%s", "href", "%s", "hreflang",
              "%s", "rel", "%s", "rev", "%s", "accesskey", "%s", "shape", "%s", "coords", "%s", "tabindex",
              "%s", "target", "%s", }),
          new AH(new String[] {})),
      // TAG = "abbr"
      ...
      new Element("AREA", false,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "shape", "%s", "coords", "%s", "href", "%s", "nohref", "", "alt", "%s",
              "tabindex", "%s", "accesskey", "%s", }),
          new AH(new String[] {})),
      // TAG = "b"
      new Element("B", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
          ...
          new AH(new String[] {})),
      // TAG = "base"
      new Element("BASE", false, new AH(new String[] { "href", "%s", "target", "%s", }),
          new AH(new String[] {})),
      // TAG = "basefont"
      new Element("BASEFONT", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "size", "%s", "color", "%s", "face", "%s", }),
          new AH(new String[] {})),
      // TAG = "big"
      ...
      new Element("BODY", true,
          new AH(new String[] { "lang", "%s", "dir", "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown",
              "%s", "onmouseup", "%s", "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s",
              "onkeypress", "%s", "onkeydown", "%s", "onkeyup", "%s", "onload", "%s", "onunload", "%s", }),
          new AH(new String[] { "background", "%s", "text", "%s", "link", "%s", "vlink", "%s", "alink", "%s",
              "bgcolor", "%s", })),
      // TAG = "br"
      new Element("BR", false, new AH(new String[] { "clear", "%s", }), new AH(new String[] {})),
      // TAG = "caption"
      new Element("CAPTION", true,
          new AH(new String[] { "lang", "%s", "dir", "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown",
              "%s", "onmouseup", "%s", "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s",
              "onkeypress", "%s", "onkeydown", "%s", "onkeyup", "%s", }),
          new AH(new String[] { "align", "%s", })),
      // TAG = "cite"
      ...
      new Element("COL", true,
          new AH(new String[] { "lang", "%s", "dir", "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown",
              "%s", "onmouseup", "%s", "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s",
              "onkeypress", "%s", "onkeydown", "%s", "onkeyup", "%s", "span", "%s", "width", "%s", "align",
              "%s", "", "", "char", "%s", "charoff", "%s", }),
          new AH(new String[] {})),
      // TAG = "colgroup"
      ...
      new Element("DD", true,
          ...
          new AH(new String[] {})),
      // TAG = "del"
      new Element("DEL", true, new AH(new String[] { "cite", "%s", "datetime", "%s", }),
          new AH(new String[] {})),
      // TAG = "dfn"
      ...
      new Element("FORM", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "action", "%s", "method", "%s", "enctype", "%s", "onsubmit", "%s",
              "onreset", "%s", "accept-charsets", "%s", "accept", "%s", }),
          new AH(new String[] {})),
      // TAG = "frame"
      new Element("FRAME", false,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "longdesc", "%s",
              "name", "%s", "src", "%s", "frameborder", "%s", "marginwidth", "%s", "marginheight", "%s",
              "noresize", "", "scrolling", "%s", }),
          new AH(new String[] {})),
      // TAG = "frameset"
      new Element("FRAMESET", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "rows", "%s", "cols",
              "%s", "onload", "%s", "onunload", "%s", }),
          new AH(new String[] {})),
      // TAG = "h1"
      new Element("H1", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
      ...
      new Element("H6", true,
          ...
          new AH(new String[] {})),
      // TAG = "head"
      new Element("HEAD", true, new AH(new String[] { "lang", "%s", "dir", "%s", "profile", "%s", }),
          new AH(new String[] {})),
      // TAG = "hr"
      new Element("HR", false,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "noshade", "", "size", "%s", "width", "%s", "align", "%s", }),
          new AH(new String[] {})),
      // TAG = "html"
      new Element("HTML", true, new AH(new String[] { "lang", "%s", "dir", "%s", }), new AH(new String[] {})),
      // TAG = "i"
      new Element("I", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
      ...
      new Element("IFRAME", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "longdesc", "%s",
              "name", "%s", "src", "%s", "frameborder", "%s", "marginwidth", "%s", "marginheight", "%s",
              "scrolling", "%s", "align", "%s", "height", "%s", "width", "%s", }),
          new AH(new String[] {})),
      // TAG = "img"
      new Element("IMG", false,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "src", "%s", "alt", "%s", "longdesc", "%s", "name", "%s", "height", "%s",
              "width", "%s", "usemap", "%s", "", "", "border", "%s", }),
          new AH(new String[] {})),
      // TAG = "input"
      new Element("INPUT", false,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "type", "%s", "name", "%s", "value", "%s", "checked", "", "disabled", "",
              "", "", "size", "%s", "maxlength", "%s", "src", "%s", "alt", "%s", "usemap", "%s", "tabindex",
              "%s", "accesskey", "%s", "border", "%s", }),
          new AH(new String[] {})),
      // TAG = "ins"
      new Element("INS", true, new AH(new String[] { "cite", "%s", "datetime", "%s", }),
          new AH(new String[] {})),
      // TAG = "kbd"
      ...
      new Element("MEDIA", false,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "charset", "%s", "href", "%s", "hreflang", "%s", "type", "%s", "rel",
              "%s", "rev", "%s", "media", "%s", }),
          new AH(new String[] {})),
      // TAG = "meta"
      new Element("META", false,
          new AH(new String[] { "lang", "%s", "dir", "%s", "http-equiv", "%s", "name", "%s", "content", "%s",
              "scheme", "%s", }),
          new AH(new String[] {})),
      // TAG = "noframes"
      ...
      new Element("OBJECT", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "declare", "", "classid", "%s", "codebase", "%s", "data", "%s", "type",
              "%s", "codetype", "%s", "archive", "%s", "standby", "%s", "height", "%s", "width", "%s",
              "usemap", "%s", "name", "%s", "tabindex", "%s", }),
          new AH(new String[] {})),
      // TAG = "ol"
      new Element("OL", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
      ...
      new Element("OPTION", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "selected", "", "disabled", "", "label", "%s", "value", "%s", }),
          new AH(new String[] {})),
      // TAG = "p"
      new Element("P", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
      ...
      new Element("PARAM", false,
          new AH(new String[] { "id", "%s", "name", "%s", "value", "%s", "valuetype", "%s", "type", "%s", }),
          new AH(new String[] {})),
      // TAG = "pre"
      ...
      new Element("SELECT", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "name", "%s", "size", "%s", "multiple", "", "disabled", "", "tabindex",
              "%s", }),
          new AH(new String[] {})),
      // TAG = "small"
      ...
      new Element("STYLE", true,
          new AH(new String[] { "lang", "%s", "dir", "%s", "type", "%s", "media", "%s", "title", "%s", }),
          new AH(new String[] {})),
      // TAG = "sub"
      ...
      new Element("TABLE", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "summary", "%s", "width", "%s", "border", "%s", "frame", "%s", "rules",
              "%s", "cellpadding", "%s", "cellspacing", "%s", }),
          new AH(new String[] { "align", "%s", "bgcolor", "%s", "height", "%s", })),
      // TAG = "tbody"
      new Element("TBODY", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown", "%s", "onmouseup", "%s",
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", "align", "%s", "char", "%s", "charoff", "%s", }),
          new AH(new String[] {})),
      // TAG = "td"
      new Element("TD", true,
          new AH(new String[] { "lang", "%s", "dir", "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown",
              "%s", "onmouseup", "%s", "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s",
              "onkeypress", "%s", "onkeydown", "%s", "onkeyup", "%s", "abbr", "%s", "axis", "%s", "headers",
              "%s", "scope", "%s", "rowspan", "%s", "colspan", "%s", "align", "%s", "char", "%s", "charoff",
              "%s", "valign", "%s", }),
          new AH(new String[] { "bgcolor", "%s", "height", "%s", "width", "%s", })),
      // TAG = "textarea"
      new Element("TEXTAREA", true,
          new AH(new String[] { "name", "%s", "rows", "%s", "cols", "%s", "id", "%s", "class", "%s", "lang",
              "%s", "title", "%s", "style", "%s", "", "", "disabled", "", "tabindex", "%s", "onfocus", "%s",
              "onblur", "%s", "onselect", "%s", "onchange", "%s", "onclick", "%s", "ondblclick", "%s",
              "onmousedown", "%s", "onmouseup", "%s", "onmouseover", "%s", "onmousemove", "%s", "onmouseout",
              "%s", "onkeypress", "%s", "onkeydown", "%s", "onkeyup", "%s", }),
          new AH(new String[] {})),
      // TAG = "tfoot"
      ...
      new Element("THEAD", true,
          ...
          new AH(new String[] {})),
      // TAG = "title"
      new Element("TITLE", true, new AH(new String[] { "lang", "%s", "dir", "%s", }),
          new AH(new String[] {})),
      // TAG = "tr"
      new Element("TR", true,
          new AH(new String[] { "lang", "%s", "dir", "%s", "onclick", "%s", "ondblclick", "%s", "onmousedown",
      ...
      new Element("UL", true,
          new AH(new String[] { "id", "%s", "class", "%s", "style", "%s", "title", "%s", "lang", "%s", "dir",
              ...
              "onmouseover", "%s", "onmousemove", "%s", "onmouseout", "%s", "onkeypress", "%s", "onkeydown",
              "%s", "onkeyup", "%s", }),
          new AH(new String[] { "type", "%s", "start", "%s", "value", "%s", "compact", "", })),
      // TAG = "var"
  ...
  protected final static String beginTag(Element el, AH args) {
    ...
    Enumeration<String> attrs = args.keys();

    while (attrs.hasMoreElements()) {
      String att = attrs.nextElement();
      ...
      if (descr == null) {
        System.err.println("Unknown/illegal attribute '" + att + "'" + " for tag '" + el.tag + "'");
      }
      ...
      if (descr.equals("%s")) {
        ...
        if (val == null) {
          System.err.println("No value specified for attribute '" + att + "'" + " of tag '" + el.tag + "'");
        }
  ...
  protected final static String endTag(Element el) {
    StringBuffer result = new StringBuffer();
    result.append("</");
    result.append(el.tag);
    result.append('>');
  ...
  protected final static String handler(int tagnum, AH args, String content, boolean omit_begin,
      boolean omit_end) {
    Element el = elements[tagnum];

    if (el == null) {
      throw new IllegalArgumentException("UNKNOWN HTML TAG '" + tagnum + "'");
    }

    StringBuffer result = new StringBuffer();

    if (!omit_begin)
      result.append(beginTag(el, args));

    if (!omit_begin && !omit_end && content != null) {
      if (!el.paired) {
        System.err.println("Error - content specified for unpaired tag '" + el.tag + "'");
      }
      result.append(content);
    }

    if (!omit_end && el.paired)
      result.append(endTag(el));
    return result.toString();
  }
